...
- `task_inserts.py` owns task insert statements and task-type side-table writes.
- `task_rows.py` maps task rows to Pydantic models and owns task-specific update helpers.
