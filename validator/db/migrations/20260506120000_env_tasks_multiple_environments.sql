...
ALTER TABLE env_tasks ADD COLUMN IF NOT EXISTS training_start_point TEXT DEFAULT 'default';
...
ALTER TABLE env_tasks DROP COLUMN IF EXISTS training_start_point;
