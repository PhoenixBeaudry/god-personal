"""Image evaluation IO and encoding helpers."""
...
def download_from_huggingface(repo_id: str, filename: str, local_dir: str) -> str | None:
...
def read_prompt_file(text_file_path: str) -> str | None:
