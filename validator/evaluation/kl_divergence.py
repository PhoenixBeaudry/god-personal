"""KL divergence scoring for GRPO-style text evaluation."""
...
def calculate_kl_divergence(
    ...
    Returns the average KL divergence across successfully processed samples.
    """
        ...
        for i in range(0, len(dataset), batch_size):
            ...
            with torch.no_grad():
                try:
                    ...
                    finetuned_log_probs = F.log_softmax(finetuned_outputs.logits, dim=-1)
