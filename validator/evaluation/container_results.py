"""Read and write evaluator result files inside evaluation containers."""
...
def save_results_dict(results_dict: dict, model_id: str | None = None) -> None:
