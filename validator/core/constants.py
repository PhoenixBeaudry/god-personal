...
PVP_LOG_LEVEL_ENV_VAR = "EVAL_LOG_LEVEL"
PVP_LOG_FORMAT = "%(asctime)s %(levelname)s %(name)s - %(message)s"
PVP_SEED_RANGE_MAX = 1_000_000
PVP_CONFIG_ID_DIVISOR = 100_000_000
PVP_SEED_OFFSET_SWAP = 1_000_000
PVP_EXECUTOR_MAX_WORKERS = 4
PVP_LOG_INTERVAL_GAMES = 100
PVP_BOT_MAX_PARSING_RETRIES = 2
