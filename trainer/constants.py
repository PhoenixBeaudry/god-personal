...
SWE_TRAJECTORIES_REPO_ID = "SWE-bench/SWE-smith-trajectories"
SWE_TRAJECTORIES_SPLIT = "tool"
SWE_TRAJECTORIES_LOCAL_DIR = f"{CACHE_DATASETS_DIR}/{SWE_TRAJECTORIES_REPO_ID.replace('/', '--')}"
