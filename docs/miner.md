...
This guide contains the miner-facing contract for Gradients on Demand tournaments. You do not need to run this repository as a miner runtime; miners participate by serving a training repository endpoint and providing a training repository that validators can build and run.
