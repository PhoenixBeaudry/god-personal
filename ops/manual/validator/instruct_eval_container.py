#!/usr/bin/env python3
"""
Manual probe for instruct evaluation of GPT-OSS-20B model.
...
def create_test_dataset(output_path: Path) -> str:
    ...
    test_data = [
        ...
        },
        {
            ...
            "output": (
                "Photosynthesis is the process by which plants use sunlight, water, and carbon dioxide to make their own "
                "food (glucose) and release oxygen as a byproduct."
            ),
        },
        {
        ...
        },
        {
            ...
            "output": (
                "Three benefits of regular exercise are: 1) Improved cardiovascular health, 2) Better mood and mental "
                "health, 3) Increased strength and endurance."
            ),
        },
        {
            "instruction": "What is machine learning?",
            "output": (
                "Machine learning is a subset of artificial intelligence that enables computers to learn and improve from "
        ...
        },
        {
            ...
            "output": (
                "A compiler translates the entire source code into machine code before execution, while an interpreter "
