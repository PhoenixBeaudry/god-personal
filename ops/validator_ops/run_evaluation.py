...
async def run_evaluation_from_task_id(
    ...
    if task_type == TaskType.IMAGETASK:
        ...
        environment_names = [task_details.environment_name] if task_details.environment_name else None
...
Examples:
  ...
  python ops/validator_ops/run_evaluation.py --task_id task_12345
  
  # Run evaluation using multiple GPUs
  python ops/validator_ops/run_evaluation.py --task_id task_12345 --gpu_ids 0 1 2
  
  # Evaluate specific models instead of those in task details
  python ops/validator_ops/run_evaluation.py --task_id task_12345 --models huggingface/model1 huggingface/model2
        """,
    )
