...
Usage:
    python -m ops.tools.tournament.complete_tournament <tournament_id>
...
async def main():
    ...
    if len(sys.argv) != 2:
        print("Usage: python -m ops.tools.tournament.complete_tournament <tournament_id>")
        print("Example: python -m ops.tools.tournament.complete_tournament tourn_abc123_20250101")
        sys.exit(1)
