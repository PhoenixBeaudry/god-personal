...
- Doubt: Challenge the opponent's claim. The hidden roll is revealed.
  If roll >= claimed rank, the claimant wins; otherwise the doubter wins.
- Accept: Do not reveal the roll. The die passes to you; you roll again, observe privately,
  and must claim a rank STRICTLY HIGHER than the previous claim. Play continues until someone Doubts.
