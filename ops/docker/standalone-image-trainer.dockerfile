...
RUN chmod +x /workspace/trainer/containers/run_image_trainer.sh
RUN chmod +x /workspace/trainer/containers/image_trainer.py

ENTRYPOINT ["/workspace/trainer/containers/run_image_trainer.sh"]
