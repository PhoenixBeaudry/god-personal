...
# Build manually:
#   docker build -f ops/docker/validator-intercode.dockerfile -t gradientsio/env-eval-intercode:basilica .
...
COPY ops/docker/intercode_build_fs.sh /opt/intercode-build/build_fs.sh
